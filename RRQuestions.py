...
def get_gertrude_status():
    try:
        ...
        prompt = (prompt = "Imagine I had a pet rock named Gertrude, who is pretty boring. Tell me the current status of Gertrude in 1 sentence. Occasionally, make it crazy or adventurous. Include interactions with people: Shadipto, Jessie, Charvi, Mrs. Tran, Nailah, Olivia, Andrew, Ronald, Archi, Jowayne, Bryce, Damola, Grace")
